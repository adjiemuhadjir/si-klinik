...
(function () {
  ...
  $(".modal-agenda").on("click", function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $(".wa").attr(
          "href",
          "https://wa.me/?text=https://pkbntb.com/agenda/lengkap/" + data.slug
        );
        $(".fb").attr(
          "href",
          "https://www.facebook.com/sharer/sharer.php?u=https://pkbntb.com/agenda/lengkap/" +
            data.slug
        );
  ...
  //Home Berita
  $(".modal-berita").on("click", function () {
    var id = $(this).data("id");
    // console.log("ID: " + id);
    $.ajax({
      type: "GET",
      ...
      success: function (data) {
        ...
        var update = new Date(data.updated_at);
        // console.log(data);
        $("#beritaTitle").text(data.judul);
        $("#berita-img").attr("src", "foto_berita/" + data.foto);
        // $("#body-berita").text(data.body);
        $("#tanggal-berita").text("Tanggal : " + tanggal.toLocaleString());
        $(".bwa").attr(
          "href",
          "https://wa.me/?text=https://pkbntb.com/berita/lengkap/" + data.slug
        );
        $(".bfb").attr(
          "href",
          "https://www.facebook.com/sharer/sharer.php?u=https://pkbntb.com/berita/lengkap/" +
            data.slug
        );
        // $("#update-berita").text("Tanggal Update: " + update.toLocaleString());
